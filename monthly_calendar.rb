...
class MonthlyCalendar
  ...
  def make_layout_status
    ...
    when true
      ...
      layout_status_result[:blank_for_1char] = "\s\s\s"
      layout_status_result[:blank_for_2char] = "\s\s"
      layout_status_result[:blank_for_3char] = ""
    ...
    when false
      ...
      layout_status_result[:blank] = "\s\s"
      layout_status_result[:blank_for_1char] = "\s"
      layout_status_result[:blank_for_2char] = ''
